      ...
      <div className="w-1/4 flex flex-col items-center mb-48">
        <div className="w-full mb-4">
          ...
          <p className="text-center text-white/80">
            가입한 이메일 주소를 입력해주세요.
            <br /> 이메일 인증 완료 후 비밀번호를 재설정할 수 있습니다.
          </p>
        </div>
        ...
        <form className="w-full">
          ...
          <div className="flex justify-between items-center">
            <Link className="text-loginBtn" to={`/login`}>
              로그인으로 돌아가기
            </Link>
            <button className="my-2 px-4 font-semibold bg-loginBtn text-btnwhite h-12 rounded-md">
              인증 메일 전송
            </button>
          </div>
        </form>
